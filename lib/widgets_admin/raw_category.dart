...
import '../view_admin/fried_view.dart';
import '../view_admin/raw_view.dart';
import '../view_admin/sauces_view.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child:Container(
        ...
        child: const Center(child: Text('Fried',style: TextStyle(
            fontSize: 30,
            fontFamily: 'poppins'
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child: Container(
        ...
        child: const Center(child: Text('Sauces',style: TextStyle(
            fontSize: 30,
            fontFamily: 'poppins'
